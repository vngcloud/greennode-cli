...
var listCmd = &cobra.Command{
	Use:   "list",
	Short: "List all elastic network interfaces",
	RunE:  runList,
}
...
func init() {
	...
	listCmd.Flags().String("name", "", "Filter by network interface name (substring match)")
}
...
func runList(cmd *cobra.Command, args []string) error {
	...
	result, err := apiClient.Get(fmt.Sprintf("/v2/%s/network-interfaces-elastic", projectID), params)
	if err != nil {
